...
first stage of the animation pipeline — pairs with `loop-animator` (make it loop),
...
site uses). You'll usually keep this JS as-is now and rework it later with `loop-animator`.
