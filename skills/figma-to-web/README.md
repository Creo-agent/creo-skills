...
> **New here / handing this off?** Start with [`HANDOFF.md`](HANDOFF.md) — what the skill is, prerequisites, the two modes, the full workflow, every tool it uses, and exactly what's in a handoff bundle vs. what you must install/connect.
...
## Hard Rules (Non-Negotiable, H1–H33 — see `reference/HARD-RULES.md`)
...
The remaining rules (H6–H31 — sentinel preservation, page skeleton, Clay-Web instance lookup, media sizing, alt text,
page-wide CTA/container consistency, blank-asset/glyph gates, motion-tell detection, and more) live only in
...
figma-to-web/
  ...
  reference/
    ...
    HARD-RULES.md         — H1–H33, non-negotiable
