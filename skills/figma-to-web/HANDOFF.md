...
**Version:** as of 2026-08-27 (HARD-RULES H1–H33). **Bundle:** `figma-to-web-skill-handoff-v01.zip`.
...
- `reference/` — 14 docs (HARD-RULES H1–H33, SECTION/FULL-PAGE workflows, CLAY-INTEGRATION,
...
- `tools/` — 5 Python tools (setup_dependencies, section_spec, qa_gate, derive_family_fingerprints, lint_skill)
...
## 7. Hard rules (H1–H33) — the non-negotiables
...
- **H1** No screenshots as content · **H2** No Clay component names in vanilla output · **H3**
  ...
  **H33** Never recreate a logo — Clay repo → Figma SVG export → stop-and-ask.
...
| `reference/HARD-RULES.md` | Always — H1–H33, non-negotiable |
