...
| [`carousel-agent-animation`](./carousel-agent-animation/) | Generate a looping HTML/CSS/JS agent-card animation from a Figma file or user-supplied images. Two styles: fan carousel (5-card overlapping loop, pure scale/position, no opacity) or floating agents (viewport-scaled scene, spring-in cards, typewriter chat bar). | SKILL.md · PROMPT.md · README.md | Moshe Schvarcz | 2026-07-20 |
